...
|---|---|---|
| 1 | Header / navegación | `src/components/Header.tsx` (`colorDelMundo`), `src/components/MundoSelector.tsx`, `src/lib/mundos.ts` (`MUNDOS_LANDING`, íconos en `src/components/icons.tsx`) |
