...
// PRNG determinístico (mulberry32) sembrado por fecha — todos los
// usuarios que entran el mismo día ven exactamente los mismos 5
// problemas, como Wordle. No usa Math.random en ningún punto.
