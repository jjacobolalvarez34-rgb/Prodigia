...
import type { ProblemaFraccion } from "@/lib/practica/fracciones";
...
export default function FraccionPracticaClient({ nivelInicial, escudosExtra, boostActivo, colorDial }: Props) {
  ...
  return (
    <div className="mx-auto flex w-full max-w-md flex-1 flex-col items-center justify-center gap-6 px-4 py-20 text-center">
      ...
      <h1 className="font-display text-2xl font-bold tracking-tight text-foreground">Fracciones</h1>
      <p className="text-texto-secundario">
        Simplificar, comparar y sumar. 10 problemas o 60 segundos, lo que llegue primero.
      </p>
