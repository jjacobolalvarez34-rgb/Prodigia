...
import { generarProblemaAlgebra, type ProblemaAlgebra } from "@/lib/practica/algebra";
...
export default function AlgebraPracticaClient({ nivelInicial, escudosExtra, boostActivo }: Props) {
  ...
  const [errores, setErrores] = useState<ProblemaAlgebra[]>([]);
  ...
  async function handleFinish(erroresPartida: ProblemaAlgebra[]) {
  ...
  return (
    <div className="mx-auto flex w-full max-w-md flex-1 flex-col items-center justify-center gap-6 px-4 py-20 text-center">
      ...
      <p className="text-texto-secundario">Evaluar expresiones y despejar x. 10 problemas o 60 segundos.</p>
