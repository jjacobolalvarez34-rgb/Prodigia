...
export default function LeccionCircuitiaClient({ nodo }: Props) {
  const t = useTranslations("Circuitia.leccion");
          ...
          <motion.div key="explicacion" {...transicion} className="flex flex-col gap-6 text-center">
            <div>
              <span
                ...
                style={{ background: `color-mix(in oklab, ${COLOR_CIRCUITIA} 12%, transparent)`, color: COLOR_CIRCUITIA }}
              >
                {t("tecnica")}
              </span>
        ...
        {fase === "celebracion" && (
          ...
          >
            ...
            <div className="mt-2 flex w-full flex-col gap-3">
              ...
              <Link href="/circuitia/practica" className="text-sm font-medium hover:underline" style={{ color: COLOR_CIRCUITIA }}>
                {t("irAPracticar")}
              </Link>
            </div>
          </motion.div>
