...
// Mismo patrón exacto que LeccionQuimiaClient.tsx, extendido con la
// fase "quiz" opcional (ver docs/PLAN_REVISION_CONTENIDO.md Proceso 1).
        ...
        {fase === "celebracion" && (
          ...
          >
            ...
            <div className="mt-2 flex w-full flex-col gap-3">
              <button
                onClick={() => router.push("/melodia/aprender")}
