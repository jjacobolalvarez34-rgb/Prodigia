        ...
        {fase === "celebracion" && (
          ...
          >
            ...
            <div className="mt-2 flex w-full flex-col gap-3">
              <button
                onClick={() => router.push(hrefVolverAAprender("/estadistica/aprender", nodo.requierePro))}
                className="rounded-xl px-4 py-3 font-display font-semibold text-white"
                style={{ background: COLOR_ESTADISTICA }}
              >
                {t("volverAAprender")}
              </button>
              <Link href="/estadistica/practica" className="text-sm font-medium hover:underline" style={{ color: COLOR_ESTADISTICA }}>
                {t("irAPracticar")}
              </Link>
            </div>
          </motion.div>
