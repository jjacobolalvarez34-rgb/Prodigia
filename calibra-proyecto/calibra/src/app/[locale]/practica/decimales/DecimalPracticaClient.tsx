...
export default function DecimalPracticaClient({ nivelPorTipo, escudosExtra, hielosDisponibles, tiemposExtraDisponibles, boostActivo }: Props) {
  ...
  const NOMBRES: Record<TipoDecimal, string> = {
    convertir: tDecimales("convertir"),
    porcentaje: tDecimales("porcentaje"),
    redondear: tDecimales("redondear"),
  };
  const [fase, setFase] = useState<Fase>("inicio");
  const [seleccion, setSeleccion] = useState<TipoDecimal[]>([...TIPOS_DECIMAL]);
  ...
  function toggle(tipo: TipoDecimal) {
