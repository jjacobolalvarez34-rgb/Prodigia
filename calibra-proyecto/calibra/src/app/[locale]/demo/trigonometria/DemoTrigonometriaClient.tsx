...
import type { ProblemaTrigonometria } from "@/lib/practica/trigonometria";
import TrigonometriaSprintRunner from "@/app/[locale]/trigonometria/TrigonometriaSprintRunner";
...
export default function DemoTrigonometriaClient() {
  const [fase, setFase] = useState<Fase>("sprint");
  const [correctos, setCorrectos] = useState(0);
  const [startedAt] = useState(() => performance.now());

  function handleFinish(_errores: ProblemaTrigonometria[], correctosReales: number) {
