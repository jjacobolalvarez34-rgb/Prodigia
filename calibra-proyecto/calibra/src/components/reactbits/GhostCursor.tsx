...
// Fase L3: decoración ambiental de fondo en las homes de mundo. El
// componente original de react-bits no trae ningún guard de rendimiento
// propio — acá SIEMPRE se monta gateado por efectosHabilitados() (ver el
// wrapper FondoCursorMundo.tsx), y con trailLength/bloom recortados
// respecto al ejemplo de la librería: el shader hace un loop de ruido
// fbm (5 octavas) por cada punto del trail, así que 50 puntos es carísimo
// para un adorno de fondo — se usa bastante menos acá.
export default function GhostCursor({
  ...
  // Nota: a diferencia de color/brightness/edgeIntensity/grainIntensity,
  // acá no hay un efecto reactivo separado para mixBlendMode — nuestro
  // uso real (FondoCursorMundo) nunca lo cambia después de montar, y el
  // efecto de setup ya lo aplica al crear el canvas.
