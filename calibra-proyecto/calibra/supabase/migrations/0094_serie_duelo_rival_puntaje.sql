-- ============================================================
-- Prodigia — Fase 2 (Rankeds "todas las ciudades": secuencia
-- automática sin botón manual): al terminar una ronda hay que mostrar
-- tus estadísticas Y las del rival — estado_serie_duelo() ya traía
-- mi_puntaje (0074) pero nunca el del rival, así que SerieDueloClient
-- no tenía con qué mostrarlo apenas la ronda queda completada.
-- Cambia el shape de RETURNS TABLE (columna nueva) → drop + create.
-- Correr después de 0093_fk_borrado_cuenta.sql.
-- ============================================================
