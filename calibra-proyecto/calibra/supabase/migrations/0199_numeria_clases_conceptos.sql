...
('numeria-clase-conceptos-basicos', 'Conceptos básicos: valor posicional, sumar y restar',
  ...
  "visuales": [
    {
      ...
      "b": 176,
      "despuesDePaso": 1,
      "titulo": "248 + 176, columna por columna"
    },
    {
      "tipo": "numeria.columnas",
      "operacion": "resta",
      ...
      "b": 178,
      "despuesDePaso": 2,
      "titulo": "532 − 178, pidiendo prestado"
    }
  ],
  "quiz": [
    {
    ...
    },
    {
      ...
      "opciones": [
        "8+6=14, se anota 4 y se lleva 1",
        "8+6=14, se anota 1 y se lleva 4",
        "8+6=14, se anota 14"
      ],
    ...
    },
    {
      ...
      "opciones": [
        "2 es menor que 8: se pide prestado y 12−8=4",
        "2 es menor que 8: el resultado es negativo",
        "2−8=6"
      ],
...
('numeria-clase-multiplicacion', 'Multiplicación en columna: productos parciales',
  'Qué significa multiplicar y cómo se arma la multiplicación en columna con productos parciales.',
  'multiplicacion',
  $numeria${
  "pasos": [
  ...
  "visuales": [
    {
      ...
      "b": 14,
      "despuesDePaso": 1,
      "titulo": "23 × 14, producto por producto"
    }
  ],
  "quiz": [
    {
      ...
      "opciones": [
        "23×1 (la decena de 14), corrido un lugar",
        "23×4, corrido un lugar",
        "23×14 completo"
      ],
...
('numeria-clase-division', 'División larga: la "casita", paso a paso',
  'Cómo repartir el dividendo dígito por dígito: bajar, ver cuántas veces entra, multiplicar y restar.',
  'division',
  $numeria${
  "pasos": [
...
('numeria-clase-mcm', 'Mínimo común múltiplo (MCM)',
  'Qué es el MCM y cómo encontrarlo listando los múltiplos de cada número hasta que coincidan.',
  'fracciones',
  $numeria${
  "pasos": [
  ...
  "quiz": [
    ...
    },
    {
      ...
      "opciones": [
        ...
        "Para simplificar cualquier fracción",
...
('numeria-clase-fracciones-operaciones', 'Operaciones entre fracciones',
  'Sumar y restar con denominador común, y multiplicar y dividir fracciones — cada una con su propio procedimiento.',
  'fracciones',
  $numeria${
  "pasos": [
