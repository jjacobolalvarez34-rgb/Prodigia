...
-- 1) Técnicas (5, requiere_pro = false): se actualizan por slug.

update public.techniques
set descripcion = 'Cuando los datos son grandes pero parecidos, supón una media y suma solo las diferencias.',
...
where slug = 'estadistica-media-desde-una-media-provisoria' and problem_type = 'estadistica';

update public.techniques
set descripcion = 'Ordena primero y calcula en qué posición está el dato del medio, sin contar de a uno.',
  contenido = $estadistica${
  "pasos": [
...
where slug = 'estadistica-mediana-por-posicion' and problem_type = 'estadistica';

update public.techniques
set descripcion = 'Parte los datos ordenados en dos mitades y saca la mediana de cada una.',
  contenido = $estadistica${
  "pasos": [
...
where slug = 'estadistica-cuartiles-por-mitades' and problem_type = 'estadistica';

update public.techniques
set descripcion = 'Cancela en vez de calcular factoriales completos y usa la simetría de las combinaciones.',
  contenido = $estadistica${
  "pasos": [
  ...
  "visuales": [
    {
      "tipo": "cuadros",
      "despuesDePaso": 1,
      "titulo": "Combinaciones sin factoriales enormes",
      "cuadros": [
        {
          "texto": "El orden no importa: se dividen las permutaciones entre $3!$."
        },
        {
          "formula": "C(10, 3) = \\dfrac{10 \\cdot 9 \\cdot 8}{3 \\cdot 2 \\cdot 1} = \\dfrac{720}{6}",
          "resaltar": "$= 120$"
        }
      ]
    },
    {
      "tipo": "cuadros",
      "despuesDePaso": 2,
      "titulo": "Simetría de las combinaciones",
      "cuadros": [
        {
          "texto": "Por simetría, $C(10, 8) = C(10, 2)$: conviene calcular con el número más chico."
        },
        {
          "formula": "C(10, 8) = C(10, 2) = \\dfrac{10 \\cdot 9}{2 \\cdot 1}",
          "resaltar": "$= 45$"
        }
      ]
    },
    {
      ...
      "cuadros": [
        {
          "texto": "El orden importa: se multiplican $3$ factores hacia abajo desde $8$, sin dividir."
        },
        {
          "formula": "P(8, 3) = 8 \\cdot 7 \\cdot 6",
          "resaltar": "$= 336$"
        }
      ]
    },
    {
      "tipo": "cuadros",
      "despuesDePaso": 4,
      "titulo": "De las permutaciones a las combinaciones",
      "cuadros": [
        {
          "texto": "El orden no importa: se dividen las permutaciones entre $3!$."
        },
        {
          "formula": "C(8, 3) = \\dfrac{8 \\cdot 7 \\cdot 6}{3 \\cdot 2 \\cdot 1} = \\dfrac{336}{6}",
          "resaltar": "$= 56$"
        }
      ]
    }
...
where slug = 'estadistica-combinatoria-sin-factoriales-enormes' and problem_type = 'estadistica';

update public.techniques
set descripcion = 'Con una media entera, las desviaciones son enteras y la varianza sale sin decimales complicados.',
  contenido = $estadistica${
  "pasos": [
...
where slug = 'estadistica-varianza-con-desvios' and problem_type = 'estadistica';

-- 2) Clases (8, requiere_pro = true): se actualizan por slug.

update public.techniques
set descripcion = 'Qué es un dato, población y muestra, y cómo clasificar cualquier variable.',
  contenido = $estadistica${
  "pasos": [
  ...
  "visuales": [
    {
      ...
      "cuadros": [
        ...
        {
          "texto": "(a) Barrio donde vive: son categorías sin un orden natural.",
          "resaltar": "Cualitativa nominal"
        },
        {
          "texto": "(b) Satisfacción (baja, media o alta): son categorías que sí se ordenan.",
          "resaltar": "Cualitativa ordinal"
        },
        {
          "texto": "(c) Cantidad de mascotas: son valores sueltos que se cuentan.",
          "resaltar": "Cuantitativa discreta"
        },
        {
          "texto": "(d) Minutos de viaje al trabajo: puede ser cualquier valor de un intervalo y se mide.",
          "resaltar": "Cuantitativa continua"
        }
      ]
    }
  ],
...
where slug = 'estadistica-clase-1-datos-y-tipos-de-variable' and problem_type = 'estadistica';

update public.techniques
set descripcion = 'Las tres medidas de tendencia central, cuándo usar cada una y por qué los extremos las afectan distinto.',
  contenido = $estadistica${
  "pasos": [
  ...
  "visuales": [
    ...
    },
    {
      ...
      "cuadros": [
        ...
        {
          "texto": "Los datos conocidos suman $4 + 9 + 11 + 7 = 31$."
        },
        {
          "formula": "40 - 31",
          "resaltar": "$= 9$ (el dato que falta)"
        }
      ]
    },
    {
...
where slug = 'estadistica-clase-2-tendencia-central' and problem_type = 'estadistica';

update public.techniques
set descripcion = 'Rango, rango intercuartílico, varianza poblacional y muestral, y cómo cambian al transformar los datos.',
  contenido = $estadistica${
  "pasos": [
...
where slug = 'estadistica-clase-3-dispersion' and problem_type = 'estadistica';

update public.techniques
set descripcion = 'De contar casos favorables a eventos independientes, dependientes y probabilidad condicional con tablas.',
  contenido = $estadistica${
  "pasos": [
...
where slug = 'estadistica-clase-4-probabilidad' and problem_type = 'estadistica';

update public.techniques
set descripcion = 'Principio multiplicativo, factorial, permutaciones y combinaciones, y su uso en probabilidad.',
  contenido = $estadistica${
  "pasos": [
  ...
  "visuales": [
    ...
    },
    {
      ...
      "cuadros": [
        {
          "texto": "Son las formas de ordenar $5$ objetos distintos."
        },
        {
          "formula": "5! = 5 \\cdot 4 \\cdot 3 \\cdot 2 \\cdot 1",
          "resaltar": "$= 120$"
        }
      ]
    },
    {
      "tipo": "cuadros",
      "despuesDePaso": 2,
      "titulo": "Un podio entre 8 corredores",
      "cuadros": [
        {
          "texto": "El orden importa: se multiplican $3$ factores hacia abajo desde $8$, sin dividir."
        },
    ...
    },
    {
      "tipo": "cuadros",
      "despuesDePaso": 3,
      "titulo": "Un comité de 3 entre 8 personas",
      "cuadros": [
        {
          "texto": "El orden no importa: se dividen las permutaciones entre $3!$."
        },
    ...
    },
    {
      ...
      "cuadros": [
        {
          "texto": "Casos posibles al sacar $2$ bolas de $10$: $C(10, 2) = 45$."
        },
        {
          "texto": "Casos con las dos rojas: $C(4, 2) = 6$."
        },
        {
          "formula": "P = \\dfrac{6}{45}",
          "resaltar": "$= \\dfrac{2}{15}$"
        }
      ]
    },
    {
      ...
      "cuadros": [
        {
          "texto": "Cada roja se puede emparejar con cada azul: $4 \\cdot 6 = 24$ pares favorables."
        },
        {
          "formula": "P = \\dfrac{24}{45}",
          "resaltar": "$= \\dfrac{8}{15}$"
        }
      ]
    }
...
where slug = 'estadistica-clase-5-combinatoria' and problem_type = 'estadistica';

update public.techniques
set descripcion = 'Medir cuántos desvíos se aleja un dato, comparar escalas distintas y ubicar un dato dentro del conjunto.',
  contenido = $estadistica${
  "pasos": [
  ...
  "visuales": [
    ...
    },
    {
      ...
      "resaltar": "posicion",
      "posicion": 8,
      "etiquetaPosicion": "El 33 es el último de 8 datos menores o iguales"
    },
    {
      "tipo": "cuadros",
      "despuesDePaso": 7,
      ...
      "cuadros": [
        {
          "texto": "Con $N = 10$ datos, los menores o iguales que $33$ son $8$."
        },
        {
          "formula": "\\dfrac{8}{10} \\cdot 100",
          "resaltar": "$= 80$ %"
        }
      ]
    }
...
where slug = 'estadistica-clase-6-normal-z-y-percentiles' and problem_type = 'estadistica';

update public.techniques
set descripcion = 'Medir la relación entre dos variables, ajustar una recta de mínimos cuadrados y no sacar conclusiones de más.',
  contenido = $estadistica${
  "pasos": [
  ...
  "quiz": [
    ...
    },
    {
      ...
      "opciones": [
        "Una variable causa a la otra",
        "No hay relación entre las variables",
        "Si x sube 1, y sube exactamente 0.9",
        "Hay una relación lineal positiva fuerte, pero eso no prueba que una cause a la otra"
      ],
...
where slug = 'estadistica-clase-7-correlacion-y-regresion' and problem_type = 'estadistica';

update public.techniques
set descripcion = 'Cómo leer barras, líneas, histogramas y diagramas de caja, y cómo detectar gráficos que engañan por escala.',
  contenido = $estadistica${
  "pasos": [
...
where slug = 'estadistica-clase-8-lectura-critica-de-graficos' and problem_type = 'estadistica';
